...
public class ComentarioController {
    ...
    public ResponseEntity<ValidateComentarioDTO> obtenerComentariosDeXProducto(@PathVariable Long idProducto) {
        ValidateComentarioDTO response = comentarioServices.obtenerComentariosDeXProducto(idProducto);
